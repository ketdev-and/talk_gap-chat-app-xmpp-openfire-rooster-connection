...
public class ChatListActivity extends AppCompatActivity implements ChatListAdapter.OnItemClickListener, ChatListAdapter.OnItemLongClickListener {
    ...
    protected static final int TalkGap_REQUEST_EXTERNAL_STORAGE = 11;
    private BroadcastReceiver mBroadcastReceiver;

    @Override
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        super.onRequestPermissionsResult(requestCode, permissions, grantResults);
        if( requestCode == TalkGap_REQUEST_EXTERNAL_STORAGE)
        {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            if(!Utilities.isServiceRunning(TalkGapChatConnectionService.class,getApplicationContext()))
            {
                Log.d(LOGTAG,"Service not running, starting it ...");
                //Start the service
                Intent i1 = new Intent(this,TalkGapChatConnectionService.class);
                startService(i1);
    ...
    private void  askStoragePermissions()
    {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            {
                requestPermissions(new String[] {Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.WRITE_EXTERNAL_STORAGE},TalkGap_REQUEST_EXTERNAL_STORAGE);
            }
        }
    ...
    private void requestBatteryOptimizationsFavor()
    {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(ChatListActivity.this);
