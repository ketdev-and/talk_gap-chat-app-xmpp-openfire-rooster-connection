...
public class LoginActivity extends AppCompatActivity {
    ...
    private static final String LOGTAG ="TalkGap Messager " ;
    ...
    private BroadcastReceiver mBroadcastReceiver; // Allows us to know when the show the ChatListActivity
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch (action)
                {
                    ...
                    case  Constants.BroadCastMessage.UI_CONNECTION_ERROR:
                        ...
                        showProgress(false);
                         mJidView.setError("something went wrong while connecting, Make sure your credentials are correct. Please try again. ");
                        break;
                }
            }
        };
